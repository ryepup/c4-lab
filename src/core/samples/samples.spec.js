...
const samples = [
    ...
    ['component', require('./component.sexp'), require('./component.dot'), "system/container"],
    ['component-with-sibling', require('./component-with-sibling.sexp'), require('./component-with-sibling.dot'), "A/a"]
]
